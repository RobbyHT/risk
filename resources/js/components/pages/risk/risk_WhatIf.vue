      ...
      <div class="right">
        <div class="m-3 p-2 border border-2 outer-border-color rounded-3">
          <div class="d-flex flex-wrap justify-content-between align-items-center">
            <h2 class="mb-0 fw-bold">What-If</h2>
            ...
            <tbody>
              <tr v-for="(data, i) in deviceList" :key="data.id">
                ...
                <td class="text-center" data-th="檢視與編輯">
                  <inertia-link :href="'/risk/WhatIf/detail/'+data.id" class="btn btn-primary mx-1">檢視</inertia-link>
                  <inertia-link :href="'/risk/WhatIf/edit/'+data.id" class="btn btn-warning mx-1">編輯</inertia-link>
                </td>
              </tr>
            </tbody>
          </table>
  ...
  export default {
    ...
    methods: {
      getData: async function() {
        ...
        await axios.get(`/api/WhatIf/device`)
        .then(function (resp) {
      ...
      del: function() {
        ...
        vm.$swal.fire({
          ...
          if (result.value) {
            axios.post(`/api/WhatIf/device/0`, {
              _method: 'DELETE',
              ids: vm.selectedList
            })
            .then(async function (resp) {
