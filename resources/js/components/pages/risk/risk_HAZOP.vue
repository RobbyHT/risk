      ...
      <div class="right">
        <div class="m-3 p-2 border border-2 outer-border-color rounded-3">
          <div class="d-flex flex-wrap justify-content-between align-items-center">
            <h2 class="mb-0 fw-bold">HAZOP</h2>
            ...
            <tbody>
              <tr v-for="(data, i) in deviceList" :key="data.id">
                ...
                <td class="text-center" data-th="檢視與編輯">
                  <inertia-link :href="'/risk/HAZOP/detail/'+data.id" class="btn btn-primary mx-1">檢視</inertia-link>
                  <inertia-link :href="'/risk/HAZOP/edit/'+data.id" class="btn btn-warning mx-1">編輯</inertia-link>
                </td>
              </tr>
            </tbody>
          </table>
  ...
  export default {
    ...
    methods: {
      getData: async function() {
        ...
        await axios.get(`/api/HAZOP/device`)
        .then(function (resp) {
