      ...
      <div class="right">
        <div class="m-3 p-2 border border-2 outer-border-color rounded-3">
          <div class="d-flex flex-wrap justify-content-between align-items-center">
            ...
            <div class="rwd-btn">
              <inertia-link href="/device/manage/add" class="btn btn-info mx-1">新增+</inertia-link>
          ...
          <table class="rwd-table table table-hover table-fixed align-middle" id="deviceTable">
            <thead class="align-center">
              <tr>
                ...
                <th scope="col" width="40%" class="text-start">設備名稱</th>
                <th scope="col" width="40%" class="text-center">區域名稱</th>
            ...
            <tbody>
              <tr v-for="data in deviceList" :key="data.id">
                ...
                <td class="text-left" data-th="設備名稱">{{data.name}}</td>
                <td class="text-center" data-th="區域名稱">{{data.region.name}}</td>
                <td class="text-center" data-th="編輯">
                  <inertia-link :href="'/device/manage/edit/'+data.id" class="btn btn-warning mx-1">編輯</inertia-link>
                </td>
              </tr>
            </tbody>
          </table>
